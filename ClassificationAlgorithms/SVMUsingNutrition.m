function [accuracy,ErrorRate,Recall,Precision,Specificity,F1,FalseAlarmRate,X,Y] = SVMUsingNutrition(label, kernalFunction)
%SVMUsingNutrition 
...
refinedTable.Properties.VariableNames = { 'kcal' 'fat' 'carbs' 'sugars' 'fibre' 'protein' 'salt' 'pre'};
...
%Train model
SVMPreModel = fitcsvm(trainingSet,label, 'KernelFunction',kernalFunction);
