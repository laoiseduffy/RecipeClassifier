function accuracy = KNNUsingMIKeywords(label)
%KNNUsingMIKeywords Summary of this function goes here
%   KNN using most relevant keywords as defined by MI scores
...
KNNModel = fitcknn(featureVector,trainingLabels);

% Use model to predict labels
featureVectorTest = createKeywordsVector(keywordsTest, words);
predictions = predict(KNNModel,featureVectorTest);
